...
2. **Важно**: всё должно собираться через Webpack или Vite (включая картинки и стили) и выкладываться на Github Pages через CI.
...
Для поиска изображений можете воспользоваться сервисом [flaticon.com](https://www.flaticon.com/ru/)
</details>
...
Важно: эта задача не является обязательной. Её выполнение не влияет на получение зачёта по ДЗ.
...
Удостоверьтесь, что всё работает при прогоне тестов в CI (не забудьте про headless-mode).
